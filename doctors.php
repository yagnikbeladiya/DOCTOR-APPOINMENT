        ...
        <div class="container">
        	<div class="card">
				...
				<div class="row align-items-center">
					...
					<div class="col-md-6">
						 <p>Name: <b><?php echo $row['name_pref'].$row['name'] ?></b></p>
						 ...
						 <p><small><a href="javascript:void(0)" class="view_schedule" data-id="<?php echo $row['id'] ?>" data-name="<?php echo $row['name_pref'].$row['name'] ?>"><i class='fa fa-calendar'></i> Schedule</a></b></small></p>
						 <p><b>Specialties:</b></p>
					...
					<div class="col-md-3 text-center align-self-end-sm">
						<button class="btn-outline-primary  btn  mb-4 set_appointment" type="button" data-id="<?php echo $row['id'] ?>"  data-name="<?php echo $row['name_pref'].$row['name'] ?>">Set Appointment</button>
					</div>
				</div>
